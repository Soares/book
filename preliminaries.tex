...
Recall that in type theory we represent propositions by types, and prove a proposition by inhabiting the corresponding type.
...
\emph{(This requires the function extensionality axiom, which is introduced in \autoref{sec:compute-pi}.)}
\end{ex}
